...
<head>
  ...
  <!-- Single modern stylesheet entry -->
  <link rel="stylesheet" href="<?php echo $base; ?>assets/css/modern.css">
  <!-- Fallbacks (optional if modern.css is present) -->
  ...
  <script src="<?php echo $base; ?>assets/js/components.js" defer></script>
...
<?php if (!$useDashboard): ?>
  <header class="site-header">
    <div class="container header-inner">
      <a class="brand" href="/"><?php echo $siteLogoPath && file_exists($siteLogoPath) ? '<img src="'.htmlspecialchars($siteLogoUrl).'?v='.time().'" alt="Logo">' : 'CyberCore'; ?></a>
      <nav class="nav" id="site-nav">
        <div class="menu-group">
          <button class="menu-link" data-submenu="produtos" aria-haspopup="true" aria-expanded="false">Produtos</button>
          <div class="submenu" id="submenu-produtos" role="menu">
            <a href="/hosting.php" role="menuitem">Alojamento Web</a>
            <a href="/servers.php" role="menuitem">Servidores</a>
            <a href="/services.php" role="menuitem">Cloud</a>
            <a href="/domains.php" role="menuitem">Domínios</a>
          </div>
        </div>
        <div class="menu-group">
          <button class="menu-link" data-submenu="solucoes" aria-haspopup="true" aria-expanded="false">Soluções</button>
          <div class="submenu" id="submenu-solucoes" role="menu">
            <a href="/services.php" role="menuitem">Sites &amp; Lojas</a>
            <a href="/services.php" role="menuitem">Email &amp; Segurança</a>
            <a href="/services.php" role="menuitem">Dev &amp; Infra</a>
          </div>
        </div>
      ...
      <div class="header-actions">
        <form class="header-search" action="/search.php" method="get">
          <input type="text" name="q" placeholder="Pesquisar produtos" aria-label="Pesquisar">
        </form>
        <a class="btn outline" href="/login.php">Login</a>
        <a class="btn primary" href="/register.php">Criar Conta</a>
        <button class="menu-toggle" aria-label="Abrir menu" data-target="site-nav">☰</button>
      </div>
    </div>
  </header>
<?php endif; ?>
