...
// Fallback shim if sendEmail is not available
...
if (!empty($errors)) {
  ...
  echo '</ul><p><a href="/contact.php">Voltar</a></p></body></html>';
  exit;
}
...
if ($sent) {
  ...
  echo '<p><a class="btn primary" href="/">Voltar ao início</a></p>';
  echo '</div></body></html>';
} else {
  http_response_code(500);
  echo '<!doctype html><html lang="pt"><head><meta charset="utf-8"><title>Erro</title></head><body>';
  echo '<h1>Ocorreu um erro ao enviar.</h1><p>Tente novamente mais tarde.</p>';
  echo '<p><a href="/contact.php">Voltar</a></p></body></html>';
}
